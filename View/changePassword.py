...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.passwordConfirmEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.passwordConfirmEdit.setFont(font)
        ...
        self.gridLayout_2.addWidget(self.passwordConfirmEdit, 2, 1, 1, 1)
